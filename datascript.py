...
def run():
    ...
    permissions_data = [
        ...
        # The following two permissions you mentioned in the list but not in your previous code - 
        # if you want to add any more, you can include here. For now all 9 are here.
        # If you want to add e.g. can_manage_users, add here.
    ]
    ...
    users_data = [
        ...
        {
            "username": "agent",
            "email": "aayamm.calcgen@gmail.com",
            "phone_number": "+9779840033590",
    ...
    for udata in users_data:
        ...
        if created:
            ...
            updated = False
            for field in ["email", "phone_number", "role", "is_staff", "is_active"]:
                if getattr(user, field) != udata[field]:
                    setattr(user, field, udata[field])
                    updated = True
            if updated:
                user.save()
